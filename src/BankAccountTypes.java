...
public class BankAccountTypes {
    public static void main(String[] args) {
        SavingsAccount savings = new SavingsAccount("SA12345", 4500.00, 2.5);
        CheckingAccount checking = new CheckingAccount("CA67890", 2000.00, 750.00);
        FixedDepositAccount fixedDeposit = new FixedDepositAccount("FD11223", 15000.00, 12);
